...
const char *gengetopt_args_info_help[] = {
  ...
  "\n Mode: Decode",
  "      --decode=filename         Decode .cod file",
  "\n Mode: Decode dir",
  "      --decode-dir=directory    Decode files .cod in diretory and its\n                                  subdirectories",
  "\n Mode: Encode",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->Decode_mode_counter = 0 ;
  args_info->Decode_dir_mode_counter = 0 ;
  args_info->Encode_mode_counter = 0 ;
  args_info->Parallel_encode_mode_counter = 0 ;
}
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->PSNR_help = gengetopt_args_info_help[2] ;
  args_info->dict_help = gengetopt_args_info_help[3] ;
  args_info->about_help = gengetopt_args_info_help[4] ;
  args_info->decode_help = gengetopt_args_info_help[6] ;
  args_info->decode_dir_help = gengetopt_args_info_help[8] ;
  args_info->encode_help = gengetopt_args_info_help[10] ;
  args_info->parallel_encode_help = gengetopt_args_info_help[12] ;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "PSNR") == 0)
          {
          ...
          /* Specify dictionary.  */
          else if (strcmp (long_options[option_index].name, "dict") == 0)
          {
          ...
          {
            args_info->Decode_mode_counter += 1;
          ...
          {
            args_info->Decode_dir_mode_counter += 1;
          ...
          {
            args_info->Encode_mode_counter += 1;
          ...
          {
            args_info->Parallel_encode_mode_counter += 1;
  ...
  if (args_info->Decode_mode_counter && args_info->Decode_dir_mode_counter) {
    int Decode_given[] = {args_info->decode_given,  -1};
    const char *Decode_desc[] = {"--decode",  0};
    int Decode_dir_given[] = {args_info->decode_dir_given,  -1};
    const char *Decode_dir_desc[] = {"--decode-dir",  0};
    error_occurred += check_modes(Decode_given, Decode_desc, Decode_dir_given, Decode_dir_desc);
  }
  if (args_info->Decode_mode_counter && args_info->Encode_mode_counter) {
    int Decode_given[] = {args_info->decode_given,  -1};
    const char *Decode_desc[] = {"--decode",  0};
    int Encode_given[] = {args_info->encode_given,  -1};
    const char *Encode_desc[] = {"--encode",  0};
    error_occurred += check_modes(Decode_given, Decode_desc, Encode_given, Encode_desc);
  }
  if (args_info->Decode_mode_counter && args_info->Parallel_encode_mode_counter) {
    int Decode_given[] = {args_info->decode_given,  -1};
    const char *Decode_desc[] = {"--decode",  0};
    int Parallel_encode_given[] = {args_info->parallel_encode_given, args_info->threads_given,  -1};
    const char *Parallel_encode_desc[] = {"--parallel-encode", "--threads",  0};
    error_occurred += check_modes(Decode_given, Decode_desc, Parallel_encode_given, Parallel_encode_desc);
  }
  if (args_info->Decode_dir_mode_counter && args_info->Encode_mode_counter) {
    int Decode_dir_given[] = {args_info->decode_dir_given,  -1};
    const char *Decode_dir_desc[] = {"--decode-dir",  0};
    int Encode_given[] = {args_info->encode_given,  -1};
    const char *Encode_desc[] = {"--encode",  0};
    error_occurred += check_modes(Decode_dir_given, Decode_dir_desc, Encode_given, Encode_desc);
  }
  if (args_info->Decode_dir_mode_counter && args_info->Parallel_encode_mode_counter) {
    int Decode_dir_given[] = {args_info->decode_dir_given,  -1};
    const char *Decode_dir_desc[] = {"--decode-dir",  0};
    int Parallel_encode_given[] = {args_info->parallel_encode_given, args_info->threads_given,  -1};
    const char *Parallel_encode_desc[] = {"--parallel-encode", "--threads",  0};
    error_occurred += check_modes(Decode_dir_given, Decode_dir_desc, Parallel_encode_given, Parallel_encode_desc);
  }
  if (args_info->Encode_mode_counter && args_info->Parallel_encode_mode_counter) {
    int Encode_given[] = {args_info->encode_given,  -1};
    const char *Encode_desc[] = {"--encode",  0};
    int Parallel_encode_given[] = {args_info->parallel_encode_given, args_info->threads_given,  -1};
    const char *Parallel_encode_desc[] = {"--parallel-encode", "--threads",  0};
    error_occurred += check_modes(Encode_given, Encode_desc, Parallel_encode_given, Parallel_encode_desc);
  }
